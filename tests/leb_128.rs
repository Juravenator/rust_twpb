...
fn test_leb128_decode_overflows() {
    // encoded i64::MIN
    let result = ::twpb::decoder::leb128_i32([0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x01].iter()).unwrap_err();
    assert_eq!(result, ::twpb::decoder::DecodeError::TooLargeVarint);
    let result = ::twpb::decoder::leb128_u32([0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x01].iter()).unwrap_err();
    assert_eq!(result, ::twpb::decoder::DecodeError::TooLargeVarint);
}
